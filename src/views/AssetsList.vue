        ...
        <div style="width: auto;clear: both;margin-top: 30px">
            <div style="width: auto;clear: both">
                <ul style="line-height: 40px;height: 40px;background: rgb(248,248,248);clear: both;font-size: 12px;font-weight: 700;color: #495060;" class="uul">
                    <li style="width: 200px;text-align: center">币名</li>
                    <li style="width: 200px;text-align: center">交易所</li>
                    <li style="width: 200px;text-align: center">总资产</li>
                    <li style="width: 200px;text-align: center">冻结</li>
                    <li style="width: 200px;text-align: center">可用</li>
                    ...
                    <div style="clear: both" >
                        <div style="width: auto;clear: both" >
                            <ul style="line-height: 50px;height: 50px;clear: both" class="uul">
                                <li style="width: 200px;text-align: center">{{list.currency}}</li>
                                <li style="width: 200px;text-align: center">全部</li>
                                <li style="width: 200px;text-align: center;color: #2d8cf0">{{list.total}}</li>
                                <li style="width: 200px;text-align: center;color: red">{{list.frozen}}</li>
                                <li style="width: 200px;text-align: center">{{list.available}}</li>
                                ...
                                <li style="width: 150px;text-align: center;cursor: pointer;color: #0e83cd"   @click="list.nnn = !list.nnn">
                                    <!--{{$t('m.Details')}}-->
                    ...
                    <div style="clear: both" >
                        <el-collapse-transition>
                            <div v-if="list.nnn">
                                ...
                                <ul style="display: flex;flex-direction: column;clear: both;background: rgb(248,248,248)" class="huzi-ul">
                                    <div>
                                        <li>
                                            <ul style="display: flex;height: 50px;line-height: 50px">
                                                <li style="width: 200px;text-align: center;"> </li><!--<li> </li>-->
                                                <li style="width: 200px!important;text-align: center;">{{option1[list.exId].label}}</li>
                                                <li style="width: 200px!important;text-align: center;">{{list.total}}</li>

                                                <li style="width: 200px!important;text-align: center;">{{list.frozen }}</li>
                                                <li style="width: 200px;text-align: center;">{{list.available}}</li>
                                                <li style="width: 150px;text-align: center;">
                                                    <router-link :to="`assetdetail?currency=${list.currency}&&exId=${list.exId}`"  >

                                                        <button style="height: 30px;line-height: 30px;font-size: 14px;font-weight:500;background-color: #2d8cf0;color: white;width: 120px;border-radius: 8px;outline: none;border: none;cursor: pointer">查看详情</button>
      ...
      getOrderList(){
        apiRequest.AssetsStatistics({
          ...
          data=>{
            ...
            let nnn1 = data.data.map((item,index)=>{
              item.nnn = false
              item.loading = true
              return item
            })
